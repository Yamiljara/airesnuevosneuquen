(function() {
  ...
  let idx; // Índice de búsqueda
  let documents; // Tus posts de Jekyll

  // Función para cargar el índice de búsqueda
  function loadSearchIndex() {
    fetch('{{ site.baseurl }}/assets/search_data.json')
  ...
  function handleSearchQuery() {
    ...
    } else if (idx && documents) {
      // Si no hay query en la URL, se muestra una lista vacía
